...
# 读取event.json文件
with open('data/eacl_2024/new_data/event.json', 'r') as event_file:
    event_data = json.load(event_file)

# 读取booklet_data.json文件
with open('data/eacl_2024/new_data/booklet_data.json', 'r') as booklet_file:
...
with open('data/eacl_2024/new_data/booklet_data.json', 'w') as booklet_file:
