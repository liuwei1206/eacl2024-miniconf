...
# 读取plenaries.json文件
with open('data/eacl_2024/new_data/plenaries.json', 'r') as f:
    plenaries_data = json.load(f)

# 读取conference.json文件
with open('data/eacl_2024/new_data/conference.json', 'r') as f:
...
with open('data/eacl_2024/new_data/conference.json', 'w') as f:
